    ...
    componentDidMount() {
        if (!this._requested) {
            ...
            if (StreamConfig.source === 'gfn') {
                ...
                const mediaPort = this.props.mediaport > 0 ? this.props.mediaport : StreamConfig.local.mediaPort;
                ...
                streamConfig = {
                    ...
                    width: this.props.resolutionWidth || StreamConfig.resolution.defaultWidth,
                    height: this.props.resolutionHeight || StreamConfig.resolution.defaultHeight,
                    fps: 60,
                    onUpdate: (message: StreamEvent) => this._onUpdate(message),
                    onStart: (message: StreamEvent) => this._onStart(message),
                    onCustomEvent: (message: any) => this._onCustomEvent(message),
